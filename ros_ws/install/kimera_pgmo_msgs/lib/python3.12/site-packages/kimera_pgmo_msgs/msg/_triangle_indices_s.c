...
bool kimera_pgmo_msgs__msg__triangle_indices__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("kimera_pgmo_msgs.msg._triangle_indices.TriangleIndices", full_classname_dest, 54) == 0);
  }
  kimera_pgmo_msgs__msg__TriangleIndices * ros_message = _ros_message;
  {  // vertex_indices
...
{
  /* NOTE(esteve): Call constructor of TriangleIndices */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("kimera_pgmo_msgs.msg._triangle_indices");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TriangleIndices");
