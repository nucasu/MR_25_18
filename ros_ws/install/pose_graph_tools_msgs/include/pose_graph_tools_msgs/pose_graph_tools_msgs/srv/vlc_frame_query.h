...
#ifndef POSE_GRAPH_TOOLS_MSGS__SRV__VLC_FRAME_QUERY_H_
#define POSE_GRAPH_TOOLS_MSGS__SRV__VLC_FRAME_QUERY_H_
...
#endif  // POSE_GRAPH_TOOLS_MSGS__SRV__VLC_FRAME_QUERY_H_
