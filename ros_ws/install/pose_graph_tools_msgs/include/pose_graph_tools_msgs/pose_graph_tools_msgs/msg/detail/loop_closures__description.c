  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0xe8, 0xf2, 0xbb, 0x9b, 0x9c, 0x63, 0x20, 0x1e,
      0xc8, 0x38, 0x5e, 0x74, 0x59, 0x3f, 0x2f, 0x7f,
      0x4e, 0xf6, 0x28, 0x58, 0x60, 0xde, 0x79, 0x8c,
      0xd5, 0x5b, 0x85, 0x49, 0x28, 0x71, 0x35, 0xf0,
    }};
  return &hash;
}
...
static char pose_graph_tools_msgs__msg__LoopClosures__TYPE_NAME[] = "pose_graph_tools_msgs/msg/LoopClosures";
...
static char pose_graph_tools_msgs__msg__LoopClosures__FIELD_NAME__publishing_robot_id[] = "publishing_robot_id";
static char pose_graph_tools_msgs__msg__LoopClosures__FIELD_NAME__destination_robot_id[] = "destination_robot_id";
static char pose_graph_tools_msgs__msg__LoopClosures__FIELD_NAME__edges[] = "edges";

static rosidl_runtime_c__type_description__Field pose_graph_tools_msgs__msg__LoopClosures__FIELDS[] = {
  {
    {pose_graph_tools_msgs__msg__LoopClosures__FIELD_NAME__publishing_robot_id, 19, 19},
    {
  ...
  {
    {pose_graph_tools_msgs__msg__LoopClosures__FIELD_NAME__destination_robot_id, 20, 20},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_UINT16,
      0,
      0,
  ...
  {
    {pose_graph_tools_msgs__msg__LoopClosures__FIELD_NAME__edges, 5, 5},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription pose_graph_tools_msgs__msg__LoopClosures__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {pose_graph_tools_msgs__msg__LoopClosures__TYPE_NAME, 38, 38},
      {pose_graph_tools_msgs__msg__LoopClosures__FIELDS, 3, 3},
    },
    {pose_graph_tools_msgs__msg__LoopClosures__REFERENCED_TYPE_DESCRIPTIONS, 6, 6},
  };
  if (!constructed) {
...
pose_graph_tools_msgs__msg__LoopClosures__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *pose_graph_tools_msgs__msg__LoopClosures__get_individual_type_description_source(NULL),
