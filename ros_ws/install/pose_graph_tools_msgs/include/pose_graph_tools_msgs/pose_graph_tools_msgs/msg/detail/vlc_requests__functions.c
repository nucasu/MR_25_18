...
pose_graph_tools_msgs__msg__VLCRequests__init(pose_graph_tools_msgs__msg__VLCRequests * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    pose_graph_tools_msgs__msg__VLCRequests__fini(msg);
    return false;
  }
  // source_robot_id
...
pose_graph_tools_msgs__msg__VLCRequests__create(void)
{
  ...
  pose_graph_tools_msgs__msg__VLCRequests * msg = (pose_graph_tools_msgs__msg__VLCRequests *)allocator.allocate(sizeof(pose_graph_tools_msgs__msg__VLCRequests), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(pose_graph_tools_msgs__msg__VLCRequests));
  bool success = pose_graph_tools_msgs__msg__VLCRequests__init(msg);
  if (!success) {
...
pose_graph_tools_msgs__msg__VLCRequests__Sequence__init(pose_graph_tools_msgs__msg__VLCRequests__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  pose_graph_tools_msgs__msg__VLCRequests * data = NULL;

  if (size) {
    data = (pose_graph_tools_msgs__msg__VLCRequests *)allocator.zero_allocate(size, sizeof(pose_graph_tools_msgs__msg__VLCRequests), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = pose_graph_tools_msgs__msg__VLCRequests__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        pose_graph_tools_msgs__msg__VLCRequests__fini(&data[i - 1]);
      }
...
pose_graph_tools_msgs__msg__VLCRequests__Sequence__fini(pose_graph_tools_msgs__msg__VLCRequests__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      pose_graph_tools_msgs__msg__VLCRequests__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  pose_graph_tools_msgs__msg__VLCRequests__Sequence * array = (pose_graph_tools_msgs__msg__VLCRequests__Sequence *)allocator.allocate(sizeof(pose_graph_tools_msgs__msg__VLCRequests__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = pose_graph_tools_msgs__msg__VLCRequests__Sequence__init(array, size);
  if (!success) {
...
pose_graph_tools_msgs__msg__VLCRequests__Sequence__destroy(pose_graph_tools_msgs__msg__VLCRequests__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    pose_graph_tools_msgs__msg__VLCRequests__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
pose_graph_tools_msgs__msg__VLCRequests__Sequence__are_equal(const pose_graph_tools_msgs__msg__VLCRequests__Sequence * lhs, const pose_graph_tools_msgs__msg__VLCRequests__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!pose_graph_tools_msgs__msg__VLCRequests__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  pose_graph_tools_msgs__msg__VLCRequests__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(pose_graph_tools_msgs__msg__VLCRequests);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    pose_graph_tools_msgs__msg__VLCRequests * data =
      (pose_graph_tools_msgs__msg__VLCRequests *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!pose_graph_tools_msgs__msg__VLCRequests__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          pose_graph_tools_msgs__msg__VLCRequests__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!pose_graph_tools_msgs__msg__VLCRequests__copy(
