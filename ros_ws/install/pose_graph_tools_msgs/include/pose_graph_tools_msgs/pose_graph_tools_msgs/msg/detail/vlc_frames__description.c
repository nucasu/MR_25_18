  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x8d, 0x08, 0xda, 0x15, 0xd9, 0x1b, 0xfe, 0xd2,
      0x8d, 0x62, 0xd9, 0x9d, 0x7a, 0xfb, 0x67, 0x6a,
      0x06, 0xaf, 0xb9, 0x80, 0xf3, 0xe3, 0x50, 0xb5,
      0x21, 0x79, 0x30, 0xad, 0x73, 0xa4, 0xce, 0xce,
    }};
  return &hash;
}
...
static char pose_graph_tools_msgs__msg__VLCFrames__TYPE_NAME[] = "pose_graph_tools_msgs/msg/VLCFrames";
...
static char pose_graph_tools_msgs__msg__VLCFrames__FIELD_NAME__header[] = "header";
static char pose_graph_tools_msgs__msg__VLCFrames__FIELD_NAME__destination_robot_id[] = "destination_robot_id";
static char pose_graph_tools_msgs__msg__VLCFrames__FIELD_NAME__frames[] = "frames";

static rosidl_runtime_c__type_description__Field pose_graph_tools_msgs__msg__VLCFrames__FIELDS[] = {
  {
    {pose_graph_tools_msgs__msg__VLCFrames__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {pose_graph_tools_msgs__msg__VLCFrames__FIELD_NAME__destination_robot_id, 20, 20},
    {
  ...
  {
    {pose_graph_tools_msgs__msg__VLCFrames__FIELD_NAME__frames, 6, 6},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription pose_graph_tools_msgs__msg__VLCFrames__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {pose_graph_tools_msgs__msg__VLCFrames__TYPE_NAME, 35, 35},
      {pose_graph_tools_msgs__msg__VLCFrames__FIELDS, 3, 3},
    },
    {pose_graph_tools_msgs__msg__VLCFrames__REFERENCED_TYPE_DESCRIPTIONS, 9, 9},
  };
  if (!constructed) {
...
pose_graph_tools_msgs__msg__VLCFrames__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *pose_graph_tools_msgs__msg__VLCFrames__get_individual_type_description_source(NULL),
