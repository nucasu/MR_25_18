...
class Metaclass_LoopClosures(type):
    """Metaclass of message 'LoopClosures'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'pose_graph_tools_msgs.msg.LoopClosures')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__loop_closures
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__loop_closures
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__loop_closures
            cls._TYPE_SUPPORT = module.type_support_msg__msg__loop_closures
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__loop_closures
...
class LoopClosures(metaclass=Metaclass_LoopClosures):
    """Message class 'LoopClosures'."""
    ...
    _fields_and_field_types = {
        ...
        'edges': 'sequence<pose_graph_tools_msgs/PoseGraphEdge>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BasicType('uint16'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['pose_graph_tools_msgs', 'msg'], 'PoseGraphEdge')),  # noqa: E501
    )
