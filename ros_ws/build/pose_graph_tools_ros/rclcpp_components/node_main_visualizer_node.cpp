...
#define NODE_MAIN_LOGGER_NAME "visualizer_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libpose_graph_tools_ros.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<pose_graph_tools_ros::Visualizer>";
