...
#define NODE_MAIN_LOGGER_NAME "rgbd_closed_set_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libsemantic_inference_ros.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<semantic_inference::RGBDSegmentationNode>";
