...
: ${AMENT_CURRENT_PREFIX:="/root/ros_workspace/install/kimera_pgmo_rviz"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/kimera_pgmo_rviz/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/kimera_pgmo_rviz/environment/path.sh"
