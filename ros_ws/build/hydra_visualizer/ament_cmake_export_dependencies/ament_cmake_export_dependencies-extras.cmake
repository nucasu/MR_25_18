...
set(_exported_dependencies "config_utilities;config_utilities_ros;hydra_msgs;ianvs;kimera_pgmo_msgs;rclcpp;spark_dsg;std_msgs;std_srvs;tf2_ros;visualization_msgs")

find_package(ament_cmake_libraries QUIET REQUIRED)

# find_package() all dependencies
# and append their DEFINITIONS INCLUDE_DIRS, LIBRARIES, and LINK_FLAGS
# variables to hydra_visualizer_DEFINITIONS, hydra_visualizer_INCLUDE_DIRS,
# hydra_visualizer_LIBRARIES, and hydra_visualizer_LINK_FLAGS.
# Additionally collect the direct dependency names in
# hydra_visualizer_DEPENDENCIES as well as the recursive dependency names
# in hydra_visualizer_RECURSIVE_DEPENDENCIES.
if(NOT _exported_dependencies STREQUAL "")
  find_package(ament_cmake_core QUIET REQUIRED)
  set(hydra_visualizer_DEPENDENCIES ${_exported_dependencies})
  set(hydra_visualizer_RECURSIVE_DEPENDENCIES ${_exported_dependencies})
  set(_libraries)
  foreach(_dep ${_exported_dependencies})
    ...
    if(NOT "${${_dep}_TARGETS}" STREQUAL "")
      foreach(_target ${${_dep}_TARGETS})
        ...
        if(TARGET "${_target}")
          ...
          if(_include_dirs)
            list_append_unique(hydra_visualizer_INCLUDE_DIRS "${_include_dirs}")
          endif()
    ...
    if(NOT use_modern_cmake)
      if(${_dep}_DEFINITIONS)
        list_append_unique(hydra_visualizer_DEFINITIONS "${${_dep}_DEFINITIONS}")
      endif()
      if(${_dep}_INCLUDE_DIRS)
        list_append_unique(hydra_visualizer_INCLUDE_DIRS "${${_dep}_INCLUDE_DIRS}")
      endif()
      if(${_dep}_LIBRARIES)
        list(APPEND _libraries "${${_dep}_LIBRARIES}")
      endif()
      if(${_dep}_LINK_FLAGS)
        list_append_unique(hydra_visualizer_LINK_FLAGS "${${_dep}_LINK_FLAGS}")
      endif()
      if(${_dep}_RECURSIVE_DEPENDENCIES)
        list_append_unique(hydra_visualizer_RECURSIVE_DEPENDENCIES "${${_dep}_RECURSIVE_DEPENDENCIES}")
      endif()
    endif()
    if(_libraries)
      ament_libraries_deduplicate(_libraries "${_libraries}")
      list(APPEND hydra_visualizer_LIBRARIES "${_libraries}")
    endif()
  endforeach()
endif()
