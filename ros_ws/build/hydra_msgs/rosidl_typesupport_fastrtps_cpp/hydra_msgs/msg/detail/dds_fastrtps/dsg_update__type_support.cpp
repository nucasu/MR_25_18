...
#include "hydra_msgs/msg/detail/dsg_update__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const hydra_msgs::msg::DsgUpdate & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  hydra_msgs::msg::DsgUpdate & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: layer_contents
  {
    ...
    size_t item_size = sizeof(ros_message.layer_contents[0]);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = hydra_msgs::msg::DsgUpdate;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const hydra_msgs::msg::DsgUpdate *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<hydra_msgs::msg::DsgUpdate *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _DsgUpdate__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const hydra_msgs::msg::DsgUpdate *>(
...
static size_t _DsgUpdate__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_DsgUpdate(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _DsgUpdate__callbacks = {
  "hydra_msgs::msg",
  "DsgUpdate",
...
static rosidl_message_type_support_t _DsgUpdate__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_DsgUpdate__callbacks,
...
{
  return &hydra_msgs::msg::typesupport_fastrtps_cpp::_DsgUpdate__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hydra_msgs, msg, DsgUpdate)() {
  return &hydra_msgs::msg::typesupport_fastrtps_cpp::_DsgUpdate__handle;
}
