...
class Metaclass_ActiveLayer(type):
    """Metaclass of message 'ActiveLayer'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'hydra_msgs.msg.ActiveLayer')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__active_layer
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__active_layer
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__active_layer
            cls._TYPE_SUPPORT = module.type_support_msg__msg__active_layer
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__active_layer
...
class ActiveLayer(metaclass=Metaclass_ActiveLayer):
    """Message class 'ActiveLayer'."""
    ...
    _fields_and_field_types = {
        ...
        'layer_contents': 'string',
        'deleted_nodes': 'sequence<int64>',
        'deleted_edges': 'sequence<int64>',
    }
    ...
    def __init__(self, **kwargs):
        ...
        self.layer_contents = kwargs.get('layer_contents', str())
    ...
    def layer_contents(self, value):
        if self._check_fields:
            assert \
                ...
                "The 'layer_contents' field must be of type 'str'"
    ...
    def deleted_nodes(self, value):
        if self._check_fields:
            ...
            assert \
                ...
                "The 'deleted_nodes' field must be a set or sequence and each value of type 'int' and each integer in [-9223372036854775808, 9223372036854775807]"
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, int) for v in value) and
                 all(val >= -9223372036854775808 and val < 9223372036854775808 for val in value)), \
                "The 'deleted_edges' field must be a set or sequence and each value of type 'int' and each integer in [-9223372036854775808, 9223372036854775807]"
