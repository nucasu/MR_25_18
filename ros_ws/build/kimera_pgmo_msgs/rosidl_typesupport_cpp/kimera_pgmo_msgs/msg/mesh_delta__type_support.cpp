...
static const _MeshDelta_type_support_symbol_names_t _MeshDelta_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, kimera_pgmo_msgs, msg, MeshDelta)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, kimera_pgmo_msgs, msg, MeshDelta)),
  }
};
...
{
  return &::kimera_pgmo_msgs::msg::rosidl_typesupport_cpp::MeshDelta_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, kimera_pgmo_msgs, msg, MeshDelta)() {
  return get_message_type_support_handle<kimera_pgmo_msgs::msg::MeshDelta>();
}
