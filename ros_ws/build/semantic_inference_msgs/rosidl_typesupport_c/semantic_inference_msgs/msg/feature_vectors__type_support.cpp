...
static const _FeatureVectors_type_support_symbol_names_t _FeatureVectors_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, semantic_inference_msgs, msg, FeatureVectors)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, semantic_inference_msgs, msg, FeatureVectors)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, semantic_inference_msgs, msg, FeatureVectors)() {
  return &::semantic_inference_msgs::msg::rosidl_typesupport_c::FeatureVectors_message_type_support_handle;
}
