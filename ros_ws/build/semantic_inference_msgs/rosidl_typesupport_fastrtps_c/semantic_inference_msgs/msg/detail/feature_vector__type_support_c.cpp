...
#include "semantic_inference_msgs/msg/detail/feature_vector__rosidl_typesupport_fastrtps_c.h"
...
using _FeatureVector__ros_msg_type = semantic_inference_msgs__msg__FeatureVector;
...
{
  const _FeatureVector__ros_msg_type * ros_message = static_cast<const _FeatureVector__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = semantic_inference_msgs__msg__FeatureVector;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const semantic_inference_msgs__msg__FeatureVector * ros_message = static_cast<const semantic_inference_msgs__msg__FeatureVector *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_semantic_inference_msgs__msg__FeatureVector(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  semantic_inference_msgs__msg__FeatureVector * ros_message = static_cast<semantic_inference_msgs__msg__FeatureVector *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_semantic_inference_msgs__msg__FeatureVector(cdr, ros_message);
}

static uint32_t _FeatureVector__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_semantic_inference_msgs__msg__FeatureVector(
...
static size_t _FeatureVector__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_semantic_inference_msgs__msg__FeatureVector(
...
static message_type_support_callbacks_t __callbacks_FeatureVector = {
...
static rosidl_message_type_support_t _FeatureVector__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_FeatureVector,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, semantic_inference_msgs, msg, FeatureVector)() {
  return &_FeatureVector__type_support;
}
