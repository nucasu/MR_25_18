...
#include "semantic_inference_msgs/msg/detail/feature_image__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const semantic_inference_msgs::msg::FeatureImage & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  semantic_inference_msgs::msg::FeatureImage & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: mask_ids
  {
    ...
    size_t item_size = sizeof(ros_message.mask_ids[0]);
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_semantic_inference_msgs
max_serialized_size_FeatureImage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = semantic_inference_msgs::msg::FeatureImage;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_semantic_inference_msgs
max_serialized_size_key_FeatureImage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const semantic_inference_msgs::msg::FeatureImage *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<semantic_inference_msgs::msg::FeatureImage *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _FeatureImage__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const semantic_inference_msgs::msg::FeatureImage *>(
...
static size_t _FeatureImage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_FeatureImage(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _FeatureImage__callbacks = {
...
static rosidl_message_type_support_t _FeatureImage__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_FeatureImage__callbacks,
...
{
  return &semantic_inference_msgs::msg::typesupport_fastrtps_cpp::_FeatureImage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, semantic_inference_msgs, msg, FeatureImage)() {
  return &semantic_inference_msgs::msg::typesupport_fastrtps_cpp::_FeatureImage__handle;
}
