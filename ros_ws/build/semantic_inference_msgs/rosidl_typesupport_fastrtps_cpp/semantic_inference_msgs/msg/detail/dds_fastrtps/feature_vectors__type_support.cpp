...
#include "semantic_inference_msgs/msg/detail/feature_vectors__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const semantic_inference_msgs::msg::FeatureVectors & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  semantic_inference_msgs::msg::FeatureVectors & ros_message)
{
  // Member: names
  {
    cdr >> ros_message.names;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_semantic_inference_msgs
max_serialized_size_FeatureVectors(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = semantic_inference_msgs::msg::FeatureVectors;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_semantic_inference_msgs
max_serialized_size_key_FeatureVectors(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const semantic_inference_msgs::msg::FeatureVectors *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<semantic_inference_msgs::msg::FeatureVectors *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _FeatureVectors__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const semantic_inference_msgs::msg::FeatureVectors *>(
...
static size_t _FeatureVectors__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_FeatureVectors(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _FeatureVectors__callbacks = {
...
static rosidl_message_type_support_t _FeatureVectors__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_FeatureVectors__callbacks,
...
{
  return &semantic_inference_msgs::msg::typesupport_fastrtps_cpp::_FeatureVectors__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, semantic_inference_msgs, msg, FeatureVectors)() {
  return &semantic_inference_msgs::msg::typesupport_fastrtps_cpp::_FeatureVectors__handle;
}
