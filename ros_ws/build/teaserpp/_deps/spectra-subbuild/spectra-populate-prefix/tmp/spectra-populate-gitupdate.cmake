...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "5c4fb1de050847988faaaaa50f60e7d3d5f16143"
  WORKING_DIRECTORY "/root/ros_workspace/build/teaserpp/_deps/spectra-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "5c4fb1de050847988faaaaa50f60e7d3d5f16143")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("5c4fb1de050847988faaaaa50f60e7d3d5f16143" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/5c4fb1de050847988faaaaa50f60e7d3d5f16143")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"5c4fb1de050847988faaaaa50f60e7d3d5f16143\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/root/ros_workspace/build/teaserpp/_deps/spectra-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/root/ros_workspace/build/teaserpp/_deps/spectra-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
