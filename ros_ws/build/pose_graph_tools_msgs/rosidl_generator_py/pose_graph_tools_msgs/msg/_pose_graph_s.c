...
bool pose_graph_tools_msgs__msg__pose_graph_node__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool pose_graph_tools_msgs__msg__pose_graph__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("pose_graph_tools_msgs.msg._pose_graph.PoseGraph", full_classname_dest, 47) == 0);
  }
  pose_graph_tools_msgs__msg__PoseGraph * ros_message = _ros_message;
  {  // header
  ...
  {  // nodes
    ...
    if (!pose_graph_tools_msgs__msg__PoseGraphNode__Sequence__init(&(ros_message->nodes), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create pose_graph_tools_msgs__msg__PoseGraphNode__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    pose_graph_tools_msgs__msg__PoseGraphNode * dest = ros_message->nodes.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!pose_graph_tools_msgs__msg__pose_graph_node__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
PyObject * pose_graph_tools_msgs__msg__pose_graph__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("pose_graph_tools_msgs.msg._pose_graph");
  ...
  {  // nodes
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = pose_graph_tools_msgs__msg__pose_graph_node__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
