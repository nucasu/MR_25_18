...
class Metaclass_PoseGraph(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from pose_graph_tools_msgs.msg import PoseGraphNode
...
class PoseGraph(metaclass=Metaclass_PoseGraph):
    ...
    _fields_and_field_types = {
        ...
        'nodes': 'sequence<pose_graph_tools_msgs/PoseGraphNode>',
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['pose_graph_tools_msgs', 'msg'], 'PoseGraphNode')),  # noqa: E501
