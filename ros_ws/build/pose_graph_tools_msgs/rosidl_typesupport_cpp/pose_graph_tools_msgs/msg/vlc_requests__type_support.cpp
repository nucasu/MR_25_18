...
static const _VLCRequests_type_support_symbol_names_t _VLCRequests_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pose_graph_tools_msgs, msg, VLCRequests)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pose_graph_tools_msgs, msg, VLCRequests)),
  }
};
...
{
  return &::pose_graph_tools_msgs::msg::rosidl_typesupport_cpp::VLCRequests_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, pose_graph_tools_msgs, msg, VLCRequests)() {
  return get_message_type_support_handle<pose_graph_tools_msgs::msg::VLCRequests>();
}
