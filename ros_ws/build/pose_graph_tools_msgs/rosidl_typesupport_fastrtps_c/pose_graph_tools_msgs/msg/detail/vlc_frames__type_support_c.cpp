...
#include "pose_graph_tools_msgs/msg/detail/vlc_frames__rosidl_typesupport_fastrtps_c.h"
...
using _VLCFrames__ros_msg_type = pose_graph_tools_msgs__msg__VLCFrames;
...
size_t get_serialized_size_pose_graph_tools_msgs__msg__VLCFrames(
  ...
  size_t current_alignment)
{
  const _VLCFrames__ros_msg_type * ros_message = static_cast<const _VLCFrames__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pose_graph_tools_msgs__msg__VLCFrames;
    is_plain =
      (
...
static bool _VLCFrames__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const pose_graph_tools_msgs__msg__VLCFrames * ros_message = static_cast<const pose_graph_tools_msgs__msg__VLCFrames *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_pose_graph_tools_msgs__msg__VLCFrames(ros_message, cdr);
}

static bool _VLCFrames__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  pose_graph_tools_msgs__msg__VLCFrames * ros_message = static_cast<pose_graph_tools_msgs__msg__VLCFrames *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_pose_graph_tools_msgs__msg__VLCFrames(cdr, ros_message);
}

static uint32_t _VLCFrames__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_pose_graph_tools_msgs__msg__VLCFrames(
      untyped_ros_message, 0));
}

static size_t _VLCFrames__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_pose_graph_tools_msgs__msg__VLCFrames(
...
static message_type_support_callbacks_t __callbacks_VLCFrames = {
  "pose_graph_tools_msgs::msg",
  "VLCFrames",
  _VLCFrames__cdr_serialize,
  _VLCFrames__cdr_deserialize,
  _VLCFrames__get_serialized_size,
  _VLCFrames__max_serialized_size,
  nullptr
};

static rosidl_message_type_support_t _VLCFrames__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_VLCFrames,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pose_graph_tools_msgs, msg, VLCFrames)() {
  return &_VLCFrames__type_support;
}
