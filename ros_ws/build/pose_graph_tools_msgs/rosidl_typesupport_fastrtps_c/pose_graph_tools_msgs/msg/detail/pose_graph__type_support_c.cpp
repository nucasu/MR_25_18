...
#include "pose_graph_tools_msgs/msg/detail/pose_graph__rosidl_typesupport_fastrtps_c.h"
...
#include "pose_graph_tools_msgs/msg/detail/pose_graph_node__functions.h"  // nodes
...
using _PoseGraph__ros_msg_type = pose_graph_tools_msgs__msg__PoseGraph;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: nodes
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_pose_graph_tools_msgs__msg__PoseGraphNode(
        &array_ptr[i], cdr);
    }
  }
  ...
  pose_graph_tools_msgs__msg__PoseGraph * ros_message)
{
  ...
  // Field name: nodes
  {
    ...
    if (ros_message->nodes.data) {
      pose_graph_tools_msgs__msg__PoseGraphNode__Sequence__fini(&ros_message->nodes);
    }
    if (!pose_graph_tools_msgs__msg__PoseGraphNode__Sequence__init(&ros_message->nodes, size)) {
      fprintf(stderr, "failed to create array for field 'nodes'");
      return false;
    }
    auto array_ptr = ros_message->nodes.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_pose_graph_tools_msgs__msg__PoseGraphNode(cdr, &array_ptr[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: nodes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_pose_graph_tools_msgs__msg__PoseGraphNode(
  ...
  size_t current_alignment)
{
  ...
  // Field name: nodes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_pose_graph_tools_msgs__msg__PoseGraphNode(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = pose_graph_tools_msgs__msg__PoseGraph;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: nodes
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_pose_graph_tools_msgs__msg__PoseGraphNode(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: nodes
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_pose_graph_tools_msgs__msg__PoseGraphNode(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: nodes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_pose_graph_tools_msgs__msg__PoseGraphNode(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const pose_graph_tools_msgs__msg__PoseGraph * ros_message = static_cast<const pose_graph_tools_msgs__msg__PoseGraph *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_pose_graph_tools_msgs__msg__PoseGraph(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  pose_graph_tools_msgs__msg__PoseGraph * ros_message = static_cast<pose_graph_tools_msgs__msg__PoseGraph *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_pose_graph_tools_msgs__msg__PoseGraph(cdr, ros_message);
}

static uint32_t _PoseGraph__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_pose_graph_tools_msgs__msg__PoseGraph(
...
static size_t _PoseGraph__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pose_graph_tools_msgs__msg__PoseGraph(
