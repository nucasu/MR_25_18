...
#include "pose_graph_tools_msgs/msg/detail/time_range_query__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const pose_graph_tools_msgs::msg::TimeRangeQuery & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pose_graph_tools_msgs::msg::TimeRangeQuery & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pose_graph_tools_msgs::msg::TimeRangeQuery;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_pose_graph_tools_msgs
max_serialized_size_key_TimeRangeQuery(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const pose_graph_tools_msgs::msg::TimeRangeQuery *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<pose_graph_tools_msgs::msg::TimeRangeQuery *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TimeRangeQuery__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const pose_graph_tools_msgs::msg::TimeRangeQuery *>(
...
static size_t _TimeRangeQuery__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TimeRangeQuery(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TimeRangeQuery__callbacks = {
...
static rosidl_message_type_support_t _TimeRangeQuery__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TimeRangeQuery__callbacks,
...
{
  return &pose_graph_tools_msgs::msg::typesupport_fastrtps_cpp::_TimeRangeQuery__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pose_graph_tools_msgs, msg, TimeRangeQuery)() {
  return &pose_graph_tools_msgs::msg::typesupport_fastrtps_cpp::_TimeRangeQuery__handle;
}
