...
#include "pose_graph_tools_msgs/msg/detail/loop_closures_ack__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const pose_graph_tools_msgs::msg::LoopClosuresAck & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: robot_src
  {
    cdr << ros_message.robot_src;
  }

  // Member: frame_src
  {
    cdr << ros_message.frame_src;
  }

  // Member: robot_dst
  {
    cdr << ros_message.robot_dst;
  }

  // Member: frame_dst
  {
    cdr << ros_message.frame_dst;
  }
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pose_graph_tools_msgs::msg::LoopClosuresAck & ros_message)
{
  // Member: publishing_robot_id
  cdr >> ros_message.publishing_robot_id;
  ...
  size_t current_alignment)
{
  ...
  // Member: robot_src
  {
    ...
    size_t item_size = sizeof(ros_message.robot_src[0]);
  ...
  // Member: frame_src
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.frame_src[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  // Member: robot_dst
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.robot_dst[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  // Member: frame_dst
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.frame_dst[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_pose_graph_tools_msgs
max_serialized_size_LoopClosuresAck(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pose_graph_tools_msgs::msg::LoopClosuresAck;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_pose_graph_tools_msgs
max_serialized_size_key_LoopClosuresAck(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const pose_graph_tools_msgs::msg::LoopClosuresAck *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<pose_graph_tools_msgs::msg::LoopClosuresAck *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _LoopClosuresAck__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const pose_graph_tools_msgs::msg::LoopClosuresAck *>(
...
static size_t _LoopClosuresAck__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_LoopClosuresAck(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _LoopClosuresAck__callbacks = {
...
static rosidl_message_type_support_t _LoopClosuresAck__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_LoopClosuresAck__callbacks,
...
{
  return &pose_graph_tools_msgs::msg::typesupport_fastrtps_cpp::_LoopClosuresAck__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pose_graph_tools_msgs, msg, LoopClosuresAck)() {
  return &pose_graph_tools_msgs::msg::typesupport_fastrtps_cpp::_LoopClosuresAck__handle;
}
