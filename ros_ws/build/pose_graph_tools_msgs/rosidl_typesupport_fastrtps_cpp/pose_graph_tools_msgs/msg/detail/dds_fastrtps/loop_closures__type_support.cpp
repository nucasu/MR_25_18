...
#include "pose_graph_tools_msgs/msg/detail/loop_closures__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const pose_graph_tools_msgs::msg::PoseGraphEdge &,
...
cdr_serialize(
  const pose_graph_tools_msgs::msg::LoopClosures & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pose_graph_tools_msgs::msg::LoopClosures & ros_message)
{
  // Member: publishing_robot_id
  cdr >> ros_message.publishing_robot_id;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_pose_graph_tools_msgs
max_serialized_size_LoopClosures(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: edges
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        pose_graph_tools_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_PoseGraphEdge(
  ...
  if (is_plain) {
    ...
    using DataType = pose_graph_tools_msgs::msg::LoopClosures;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_pose_graph_tools_msgs
max_serialized_size_key_LoopClosures(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: edges
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        pose_graph_tools_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_PoseGraphEdge(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const pose_graph_tools_msgs::msg::LoopClosures *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<pose_graph_tools_msgs::msg::LoopClosures *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _LoopClosures__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const pose_graph_tools_msgs::msg::LoopClosures *>(
...
static size_t _LoopClosures__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_LoopClosures(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _LoopClosures__callbacks = {
...
static rosidl_message_type_support_t _LoopClosures__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_LoopClosures__callbacks,
...
{
  return &pose_graph_tools_msgs::msg::typesupport_fastrtps_cpp::_LoopClosures__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pose_graph_tools_msgs, msg, LoopClosures)() {
  return &pose_graph_tools_msgs::msg::typesupport_fastrtps_cpp::_LoopClosures__handle;
}
