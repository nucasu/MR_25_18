...
#include "pose_graph_tools_msgs/msg/detail/pose_graph__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const pose_graph_tools_msgs::msg::PoseGraphNode &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  pose_graph_tools_msgs::msg::PoseGraphNode &);
size_t get_serialized_size(
  const pose_graph_tools_msgs::msg::PoseGraphNode &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const pose_graph_tools_msgs::msg::PoseGraph & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pose_graph_tools_msgs::msg::PoseGraph & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: nodes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        pose_graph_tools_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_PoseGraphNode(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = pose_graph_tools_msgs::msg::PoseGraph;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: nodes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        pose_graph_tools_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_PoseGraphNode(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const pose_graph_tools_msgs::msg::PoseGraph *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<pose_graph_tools_msgs::msg::PoseGraph *>(
    untyped_ros_message);
...
{
  return &pose_graph_tools_msgs::msg::typesupport_fastrtps_cpp::_PoseGraph__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pose_graph_tools_msgs, msg, PoseGraph)() {
  return &pose_graph_tools_msgs::msg::typesupport_fastrtps_cpp::_PoseGraph__handle;
}
