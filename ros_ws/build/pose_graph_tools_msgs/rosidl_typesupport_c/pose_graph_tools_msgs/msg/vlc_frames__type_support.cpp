...
static const _VLCFrames_type_support_symbol_names_t _VLCFrames_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pose_graph_tools_msgs, msg, VLCFrames)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pose_graph_tools_msgs, msg, VLCFrames)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, pose_graph_tools_msgs, msg, VLCFrames)() {
  return &::pose_graph_tools_msgs::msg::rosidl_typesupport_c::VLCFrames_message_type_support_handle;
}
