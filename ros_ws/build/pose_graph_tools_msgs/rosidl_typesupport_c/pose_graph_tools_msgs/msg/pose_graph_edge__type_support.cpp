...
static const _PoseGraphEdge_type_support_symbol_names_t _PoseGraphEdge_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pose_graph_tools_msgs, msg, PoseGraphEdge)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pose_graph_tools_msgs, msg, PoseGraphEdge)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, pose_graph_tools_msgs, msg, PoseGraphEdge)() {
  return &::pose_graph_tools_msgs::msg::rosidl_typesupport_c::PoseGraphEdge_message_type_support_handle;
}
