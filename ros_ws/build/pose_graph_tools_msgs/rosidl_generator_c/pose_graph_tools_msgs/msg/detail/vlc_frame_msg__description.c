...
static char pose_graph_tools_msgs__msg__VLCFrameMsg__FIELD_NAME__robot_id[] = "robot_id";
static char pose_graph_tools_msgs__msg__VLCFrameMsg__FIELD_NAME__pose_id[] = "pose_id";
static char pose_graph_tools_msgs__msg__VLCFrameMsg__FIELD_NAME__submap_id[] = "submap_id";
static char pose_graph_tools_msgs__msg__VLCFrameMsg__FIELD_NAME__descriptors_mat[] = "descriptors_mat";
static char pose_graph_tools_msgs__msg__VLCFrameMsg__FIELD_NAME__versors[] = "versors";
static char pose_graph_tools_msgs__msg__VLCFrameMsg__FIELD_NAME__depths[] = "depths";
static char pose_graph_tools_msgs__msg__VLCFrameMsg__FIELD_NAME__submap_from_pose[] = "submap_from_pose";

static rosidl_runtime_c__type_description__Field pose_graph_tools_msgs__msg__VLCFrameMsg__FIELDS[] = {
  {
    {pose_graph_tools_msgs__msg__VLCFrameMsg__FIELD_NAME__robot_id, 8, 8},
    {
  ...
  {
    {pose_graph_tools_msgs__msg__VLCFrameMsg__FIELD_NAME__pose_id, 7, 7},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_UINT32,
      0,
      0,
  ...
  {
    {pose_graph_tools_msgs__msg__VLCFrameMsg__FIELD_NAME__submap_id, 9, 9},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_UINT32,
      0,
      0,
  ...
  {
    {pose_graph_tools_msgs__msg__VLCFrameMsg__FIELD_NAME__descriptors_mat, 15, 15},
    {
  ...
  {
    {pose_graph_tools_msgs__msg__VLCFrameMsg__FIELD_NAME__versors, 7, 7},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {pose_graph_tools_msgs__msg__VLCFrameMsg__FIELD_NAME__depths, 6, 6},
    {
  ...
  {
    {pose_graph_tools_msgs__msg__VLCFrameMsg__FIELD_NAME__submap_from_pose, 16, 16},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription pose_graph_tools_msgs__msg__VLCFrameMsg__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {pose_graph_tools_msgs__msg__VLCFrameMsg__FIELDS, 7, 7},
    },
    {pose_graph_tools_msgs__msg__VLCFrameMsg__REFERENCED_TYPE_DESCRIPTIONS, 8, 8},
  };
  if (!constructed) {
...
static char toplevel_type_raw_source[] =
  ...
  "geometry_msgs/Pose submap_from_pose";
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *pose_graph_tools_msgs__msg__VLCFrameMsg__get_individual_type_description_source(NULL),
