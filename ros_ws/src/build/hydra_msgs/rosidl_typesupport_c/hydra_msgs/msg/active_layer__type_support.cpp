...
static const _ActiveLayer_type_support_symbol_names_t _ActiveLayer_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hydra_msgs, msg, ActiveLayer)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hydra_msgs, msg, ActiveLayer)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, hydra_msgs, msg, ActiveLayer)() {
  return &::hydra_msgs::msg::rosidl_typesupport_c::ActiveLayer_message_type_support_handle;
}
