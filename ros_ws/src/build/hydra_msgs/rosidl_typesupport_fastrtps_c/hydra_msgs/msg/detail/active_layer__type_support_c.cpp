...
#include "hydra_msgs/msg/detail/active_layer__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // deleted_edges, deleted_nodes
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // deleted_edges, deleted_nodes
#include "rosidl_runtime_c/string.h"  // layer_contents
#include "rosidl_runtime_c/string_functions.h"  // layer_contents
...
using _ActiveLayer__ros_msg_type = hydra_msgs__msg__ActiveLayer;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    const rosidl_runtime_c__String * str = &ros_message->layer_contents;
  ...
  hydra_msgs__msg__ActiveLayer * ros_message)
{
  ...
  // Field name: layer_contents
  {
    ...
    if (!ros_message->layer_contents.data) {
      rosidl_runtime_c__String__init(&ros_message->layer_contents);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->layer_contents,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'layer_contents'\n");
      return false;
    }
  }
  ...
  // Field name: deleted_nodes
  {
    ...
    if (ros_message->deleted_nodes.data) {
      rosidl_runtime_c__int64__Sequence__fini(&ros_message->deleted_nodes);
    }
  ...
  // Field name: deleted_edges
  {
    ...
    if (ros_message->deleted_edges.data) {
      rosidl_runtime_c__int64__Sequence__fini(&ros_message->deleted_edges);
    }
...
size_t get_serialized_size_hydra_msgs__msg__ActiveLayer(
  ...
  size_t current_alignment)
{
  const _ActiveLayer__ros_msg_type * ros_message = static_cast<const _ActiveLayer__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = hydra_msgs__msg__ActiveLayer;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const hydra_msgs__msg__ActiveLayer * ros_message = static_cast<const hydra_msgs__msg__ActiveLayer *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_hydra_msgs__msg__ActiveLayer(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  hydra_msgs__msg__ActiveLayer * ros_message = static_cast<hydra_msgs__msg__ActiveLayer *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_hydra_msgs__msg__ActiveLayer(cdr, ros_message);
}

static uint32_t _ActiveLayer__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_hydra_msgs__msg__ActiveLayer(
...
static size_t _ActiveLayer__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_hydra_msgs__msg__ActiveLayer(
...
static message_type_support_callbacks_t __callbacks_ActiveLayer = {
  "hydra_msgs::msg",
  "ActiveLayer",
...
static rosidl_message_type_support_t _ActiveLayer__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ActiveLayer,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hydra_msgs, msg, ActiveLayer)() {
  return &_ActiveLayer__type_support;
}
